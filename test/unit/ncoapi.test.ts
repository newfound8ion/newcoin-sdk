...
import {
    ...
    NCStakeMainDao, NCDaoProposalVote, NCDaoWithdrawVoteDeposit, NCGetDaoProposals, NCGetVotes,
...
const api = new NCO_BlockchainAPI(
{
    ...
    describe("tx NCO transactions", () => {
        it("tx nco balance", async () => {
            console.log("transferring some NCO to resp");
            let n: NCTxNcoBal = { 
                to:   name, 
                amt: '1500.0000 NCO', 
                payer:'io',
            ...
            it("Mint asset basic", async () => {
                ...
                let n: NCMintAsset = {
                    ...
                    immutable_data: [
                        ...
                        {
                            'key': 'image',
                            'value': ['string', 'https://storage.googleapis.com/opensea-prod.appspot.com/creature/50.png']
                        },
